...
import { sortFields, sortOrders, allergenOptions, preferenceOptions, diningOptions, mealTypeOptions } from './filter_options';
...
export const Filters: React.FC<FiltersProps> = ({ sortField, setSortField, sortOrder, setSortOrder, selectedAllergens, setSelectedAllergens, diningHall, setDiningHall, mealType, setMealType, selectedPreference, setSelectedPreference, dateServed, setDateServed, dates }) => {
    ...
    <>
        ...
        <div style={{ flexGrow: 1, flexBasis: 0 }}>
            <Select
                ...
                value={allergenOptions.filter((option) => selectedAllergens.includes(option.value))}
        ...
        <div style={{ flexGrow: 1, flexBasis: 0 }}>
            <Select
                ...
                value={preferenceOptions.find((option) => option.value === selectedPreference)}
                onChange={(option) => setSelectedPreference(option ? option.value : "")}
            />
        </div>
        <div style={{ flexGrow: 1, flexBasis: 0 }}>
            <Select
                ...
                value={diningOptions.find((option) => option.value === diningHall)}
